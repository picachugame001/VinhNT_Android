...
class Func_Update_CauThu extends \class_dir\BaseFunction{
	...
	function __construct($inputArray) {
		...
		$this->update_cau_thu($user,$old_pass,$new_pass,$ho_ten_dem,$ten,$gioi_tinh,$ngay_sinh,$dia_chi,$so_cmnd,$so_dien_thoai,$email);
	}
								...
								)
	{
		...
		//
		$mangKetQua = $ketnoi_SQL->query_get_data('Proc_Update_CauThu',$param_array);
